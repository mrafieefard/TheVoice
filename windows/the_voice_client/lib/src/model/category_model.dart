...
abstract class CategoryModel
  ...
  factory CategoryModel([void updates(CategoryModelBuilder b)]) =
      _$CategoryModel;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CategoryModelBuilder b) => b;
...
class _$CategoryModelSerializer implements PrimitiveSerializer<CategoryModel> {
  @override
  final Iterable<Type> types = const [CategoryModel, _$CategoryModel];

  @override
  final String wireName = r'CategoryModel';
  ...
  void _deserializeProperties(
    ...
    required CategoryModelBuilder result,
